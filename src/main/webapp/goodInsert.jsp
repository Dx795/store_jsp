    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                ...
                <form action="GoodsServlet?type=insertSJGood" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                                <th><i class="require-red">*</i>商品名：</th>
                                <td>
                                    <input class="common-text required" id="title" name="gname" size="50"  type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="inPrice" size="50" type="text">
                                </td>
                            </tr>
                              <tr>
                                <th><i class="require-red">*</i>库存：</th>
                                <td>
                                    <input class="common-text required" id="title" name="stock" size="50" type="text">
                                </td>
                            </tr>
                        <tr>
                            ...
                            <tr>
                                <th>介绍内容：</th>
                                <td><textarea name="introduction" class="common-textarea" id="content" cols="30" style="width: 70%;" rows="5"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
